...
![version](https://img.shields.io/badge/version-2.2.5-2F5BFF)
...
[下载 Windows 安装版 v2.2.5](https://github.com/jileyu2000/archresearch/releases/download/v2.2.5/ArchResearch-Windows-x64-Setup-v2.2.5.exe)

1. 下载并运行 `ArchResearch-Windows-x64-Setup-v2.2.5.exe`。
2. 首次启动时填写自己的 OpenAI-compatible API 地址和 API Key，再从接口返回的模型列表中选择模型。
3. 以后从桌面或开始菜单打开 ArchResearch，研究工作台会自动显示在 Chrome 中。

安装器已经包含本地服务、工作界面、数据库和运行环境，不需要另外安装 Python 或 Node.js。安装程序暂未签名，Windows 可能显示 SmartScreen 或“未知发布者”，可以在 [v2.2.5 Release](https://github.com/jileyu2000/archresearch/releases/tag/v2.2.5) 核对附件和 SHA-256。

### 使用图纸灵感

“图纸灵感”需要单独安装 Chrome 扩展。Windows 安装器不会捆绑扩展。

[下载 Chrome 扩展 v2.2.5](https://github.com/jileyu2000/archresearch/releases/download/v2.2.5/archresearch-chrome-extension-only-v2.2.5.zip) · [查看安装说明](docs/chrome-extension.md)
