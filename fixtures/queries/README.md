...
`research_tasks.jsonl` contains 25 human-authored architecture research tasks. It is a data fixture and never starts network research by itself.
...
The set covers 20 precedent research tasks and five visual reference searches. All asset labels use the production nine-class enum.
