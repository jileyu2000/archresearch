...
- 提交 `c08465a` 推送到 `codex/archresearch-windows-installer`，draft PR #3 创建后 push/PR 两套 fresh Windows CI `30516069001`、`30516103148` 分别 18:01、18:59 全绿；PR 合并为 `bbc79ee`，main CI `30517007300` 15:01 全绿。三套均覆盖新增的独立扩展/安装器构建、真实安装 smoke 和原完整门禁。
