...
| 21. M20 Live architecture research acceptance | in_progress | Run one bounded real Quick task through gpt-5.5 and Firecrawl, verify Chinese decomposition, live sources, visual leads, evidence boundaries and result-page usability, then record concrete gaps |
