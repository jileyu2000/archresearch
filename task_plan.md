...
| M163 public Web Xiaohongshu bridge | in_progress | 严格协议、动态公共页连接、扩展内有界小红书搜索、Web/Edge 输入与主页面安装提醒已按红绿测试实现；根级 coverage 与完整门禁通过 360 API / 183 Board / 186 Extension / 11 Web / 18 Edge / 8 packaged E2E，1440/390 QA 和 `2.1.2` ZIP 已完成。首轮 CI 只因旧 coverage 门槛失败且已补测修复；剩余：第二轮 Hosted CI、生产部署/线上 smoke 与 GitHub `v2.1.2` Release。 |
